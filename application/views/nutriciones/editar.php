<div class="container">
    <div class="row">
        <div class="col-md-12 text-center">
            <br>
            <br>
            <h1 style="color:red;"><b>EDITAR LA NUTRICION DEL BOVINO</b></h1>
            <br>
            <br>
        </div>
    </div>
...
<div class="container">
    ...
    action="<?php echo site_url('nutriciones/procesarActualizacion'); ?>" 
    method="post">
        <div class="row">
            <input type="text" name="id_nut" id="id_nut"
            value="<?php echo $nutricionEditar->id_nut; ?>">
            ...
            <div class="col-md-4 text-center">
                ...
                required
                name="nom_nut" 
                value="<?php echo $nutricionEditar->nom_nut; ?>"
                id="nom_nut">
            </div>
            ...
            <div class="col-md-4 text-center">
                ...
                required
                name="porcentaje_nut" 
                value="<?php echo $nutricionEditar->porcentaje_nut; ?>"
                id="porcentaje_nut">
            </div>
            ...
            <div class="col-md-4 text-center">
                ...
                required
                name="tipo_nut" 
                value="<?php echo $nutricionEditar->tipo_nut; ?>"
                id="tipo_nut">
            </div>
            ...
            <div class="col-md-4 text-center">
                ...
                required
                name="det_nut" 
                value="<?php echo $nutricionEditar->det_nut; ?>"
                id="det_nut">
            </div>

<div class="container">
    <div class="row">
        <div class="col-md-12 text-center">
            <br>
            <br>
            <h1 style="color:red;"><b>EDITAR PRODUCCION DE PASTEURIZACION</b></h1>
            <br>
            <br>
        </div>
    </div>
...
<div class="container">
    ...
    action="<?php echo site_url('pasteurizaciones/procesarActualizacion'); ?>" 
    method="post">
        <div class="row">
            <input type="text" name="id_pat" id="id_pat"
            value="<?php echo $pasteurizacionEditar->id_pat; ?>">
            ...
            <div class="col-md-4 text-center">
                ...
                required
                name="fec_pat" 
                value="<?php echo $pasteurizacionEditar->fec_pat; ?>"
                id="fec_pat">
            </div>
            ...
            <div class="col-md-4 text-center">
                ...
                required
                name="pro_pat" 
                value="<?php echo $pasteurizacionEditar->pro_pat; ?>"
                id="pro_pat">
            </div>
            ...
            <div class="col-md-4 text-center">
                ...
                required
                name="tem_pat" 
                value="<?php echo $pasteurizacionEditar->tem_pat; ?>"
                id="tem_pat">
            </div>
            ...
            <div class="col-md-4 text-center">
                ...
                required
                name="obs_pat" 
                value="<?php echo $pasteurizacionEditar->obs_pat; ?>"
                id="obs_pat">
            </div>

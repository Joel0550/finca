<div class="container">
    <div class="row">
        <div class="col-md-12 text-center">
            <br>
            <br>
            <h1 style="color:red;"><b>EDITAR PRODUCCION</b></h1>
            <br>
            <br>
        </div>
    </div>
...
<div class="container">
    ...
    action="<?php echo site_url('producciones/procesarActualizacion'); ?>" 
    method="post">
        <div class="row">

            <input type="text" name="cod_pro" id="cod_pro"
            value="<?php echo $produccionEditar->cod_pro; ?>">
            ...
            <div class="col-md-4 text-center">
                ...
                class="form-control"
                required
                name="cod_pro" value="<?php echo $produccionEditar->cod_pro; ?>"
                id="cod_pro">
            </div>
            ...
            <div class="col-md-4 text-center">
                ...
                class="form-control" 
                required
                name="tipo_pro" value="<?php echo $produccionEditar->tipo_pro; ?>"
                id="tipo_pro">
            </div>
            ...
            <div class="col-md-4 text-center">
                ...
                class="form-control"
                required
                name="fecha_pro" value="<?php echo $produccionEditar->fecha_pro; ?>"
                id="fecha_pro">
            </div>
        </div>
        <br>

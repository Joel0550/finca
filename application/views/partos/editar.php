...
<div class="container">
    ...
    action="<?php echo site_url('partos/procesarActualizacion'); ?>" 
    method="post">
        <div class="row">
            <input type="text" name="cod_par" id="cod_par"
            value="<?php echo $partoEditar->cod_par; ?>">
            ...
            <div class="col-md-4 text-center">
                ...
                class="form-control" 
                required
                name="cod_par" value="<?php echo $partoEditar->cod_par; ?>"
                id="cod_par">
            </div>
            ...
            <div class="col-md-4 text-center">
                ...
                class="form-control" 
                required
                name="num_par" value="<?php echo $partoEditar->num_par; ?>"
                id="num_par">
            </div>
            ...
            <div class="col-md-4 text-center">
                ...
                class="form-control" 
                required
                name="fecha_par" value="<?php echo $partoEditar->fecha_par; ?>"
                id="fecha_par">
            </div>
